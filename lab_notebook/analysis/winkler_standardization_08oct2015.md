...
### Data entry
    ...
    std.end.buret <- c(0.15, 0.35, 0.50)
    blank.begin1 <- c(0.50, 0.85, 1.40)
    blank.end1 <- c(0.70, 1.05, 1.60)
    blank.begin2 <- c(0.70, 1.05, 1.60)
    blank.end2 <- c(0.85, 1.20, 1.725)
    Vstd <- 0.2
    MnCl.vol <- 0.085
    NaI.vol <- 0.085
    Nstd <- 0.01
...
## Output
    ...
    write.table(std, file = "./data/winkler_standardization_08oct2015.csv", quote = F, row.names = F, sep = ",")
